...
class ExportTab(QWidget):
    ...
    def _export_format_group(self) -> QGroupBox:
        ...
        # Radio naming sidecar — barra blu sotto il checkbox XMP sidecar
        ...
        self.sidecar_lr.setStyleSheet("color: #87CEEB; font-size: 11px; background: transparent;")
        self.sidecar_dt = QRadioButton(t("export.radio.sidecar_dt"))
        self.sidecar_dt.setToolTip(t("export.tooltip.sidecar_dt"))
        self.sidecar_dt.setStyleSheet("color: #87CEEB; font-size: 11px; background: transparent;")
        ...
        naming_bar = QWidget()
        naming_bar.setStyleSheet("background-color: #1a3a50; border-radius: 4px;")
        naming_row = QHBoxLayout(naming_bar)
        naming_row.setContentsMargins(10, 4, 10, 4)
        naming_row.setSpacing(10)
        lbl_naming = QLabel(t("sidecar.mode.label"))
        lbl_naming.setStyleSheet("color: #87CEEB; font-size: 11px; font-weight: bold; background: transparent;")
        naming_row.addWidget(lbl_naming)
        naming_row.addWidget(self.sidecar_lr)
        naming_row.addWidget(self.sidecar_dt)
        naming_row.addStretch()
        self.sidecar_naming_widget = naming_bar
