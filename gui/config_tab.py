...
class ConfigTab(QWidget):
    ...
    def create_paths_section(self):
        ...
        # Root Path (archivio principale)
        layout.addWidget(QLabel("Archivio Root:"), 1, 0)
        self.root_path_edit = QLineEdit()
        self.root_path_edit.setToolTip("Directory principale archivio foto")
        self.root_path_edit.setPlaceholderText("Es: D:/Foto/Archivio")
        layout.addWidget(self.root_path_edit, 1, 1)
        
        root_browse_btn = QPushButton("📂")
        root_browse_btn.setFixedWidth(40)
        root_browse_btn.clicked.connect(lambda: self._select_directory(self.root_path_edit, "Seleziona Root Path Immagini"))
        layout.addWidget(root_browse_btn, 1, 2)
        
        # Log Directory
        layout.addWidget(QLabel("Dir Log:"), 2, 0)
        self.log_dir_edit = QLineEdit()
        self.log_dir_edit.setToolTip("Directory salvataggio file log")
        self.log_dir_edit.setPlaceholderText("Es: logs")
        layout.addWidget(self.log_dir_edit, 2, 1)
        ...
        layout.addWidget(log_browse_btn, 2, 2)
    ...
    def load_config(self):
        ...
        try:
            ...
            self.root_path_edit.setText(paths['root_path'])
