...
Il problema
-----------
`_find_existing_install()` in installer.py cerca l'installazione SOLO nella
cartella predefinita (~/OffGallery). Chi installa altrove ottiene comunque un
installer_state.json valido, ma dentro la propria cartella: al riavvio il
Manager non sa dove guardare, non lo trova, e ripropone il wizard da capo
chiedendo la cartella a mano — anche se l'installazione c'e' ed e' completa
(segnalazione utente 2026-09-03).
