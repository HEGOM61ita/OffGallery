...
la prima installazione (vedi `_shortcut_windows` in ui/wizard.py). Il collegamento
"OffGallery Manager" punta a quella copia, che poi non viene piu' aggiornato da
...
def copia_e_in_uso(install_path: str) -> bool:
    ...
    Windows blocca il file di un processo in esecuzione: la sostituzione
    fallirebbe. Va intercettato prima, per poter dare all'utente un messaggio
    comprensibile invece di un errore di sistema.
    """
    import sys
